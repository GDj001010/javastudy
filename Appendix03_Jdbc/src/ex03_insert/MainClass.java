...
public class MainClass {
	...
	/*
		ps.executeUpdate(); - insert, update, delete	- DML 사용 메소드
		"1"행 삽입, "0"행 삽입  - 숫자 int 값.
	*/
	// 상수 삽입
	...
	public static void ex02() {
		...
		try {
			...
			ps.setString(1, id);		// 첫번 째 물음표(?) 자리에 id를 넣으시오.
			ps.setString(2, name);		// 두번 째 물음표(?) 자리에 id를 넣으시오.
			ps.setString(3, address);	// 세번 째 물음표(?) 자리에 id를 넣으시오.
