...
public class Ex02_Random {
	...
	/*
		...
		2. 예시 
			1) java.util.Random 클래스의 경우 import java.util.Random 방식으로 사용 된다.
			2) import java.util.*; 방식으로 java.util 패키지의 모든 클래스를 import 할 수 있다.
		3. import를 생략할 수 있는 경우
			1) java.lang 패키지의 클래스
			2) 동일한 패키지의 클래스
		4. import 방식 : 클래스를 입력할 때 "항상" 자동 완성을 이용한다. 					무조건 지키기
	*/
	/*
	 	java.util.Random  < 최초 한 번은 java.util에서 불러와야 한다. (import 한다)
	 	java.lang  < 생략 가능
	*/	
	/*
		java.util.Random
