...
public class ContactServiceImpl implements ContactService {
	...
	public void addContact() {
		...
		System.out.println(addResult + "개의 연락처가 등록되었습니다."); // 1개 아니면 0개 나옴.
	...
	public void removeContact() {
		...
		List<ContactDTO> contactList = dao.selectContactsByName(name);		// insert, delete, update 가 두 번 이상이여야 트랜잭션 대상이지만 현 메소드에선 select, insert 라 대상이 아니다.
